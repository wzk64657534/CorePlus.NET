$(function () {
    ...
    function SelectedDate(v) {
        ...
        //        startDate = CoreDate.AddDays(v).replace(/\//g, '-');
        //        endDate = CoreDate.GetDate().replace(/\//g, '-');
        //        var period = '(' + startDate + '至' + endDate + ')';
    ...
    function Report(s, e, i, t) {
        ...
        switch (tag) {
            case '1':
                cols.push({ field: 'RefererSite', title: '全站统计', width: 200, align: 'center' });
