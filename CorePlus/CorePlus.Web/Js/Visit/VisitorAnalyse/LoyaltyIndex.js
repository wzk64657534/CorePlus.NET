$(function () {
    ...
    function Report(s, e, i, t) {
        ...
        switch (tag) {
            case '1':
                cols.push({ field: 'NAME', title: '日访问频度', width: 200, align: 'center' });
                cols.push({ field: 'UV', title: '独立访客(UV)', width: 200, align: 'center' });
                cols.push({ field: 'UVPRE', title: '占比', width: 200, align: 'center' });
        ...
        $('#dg').datagrid({
            ...
            url: '/VisitorLoyalty/GetDataOfGrid',
